...
| **expires\_at** | **Integer** | The time the quote expires in unix timestamp. | [default to null] |
...
| **created\_at** | **Integer** | The time the quote was created in unix timestamp. | [default to null] |
