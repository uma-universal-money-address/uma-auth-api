...
class ExecuteQuoteResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExecuteQuoteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ExecuteQuoteResponse from a dict"""
        if obj is None:
            return None
