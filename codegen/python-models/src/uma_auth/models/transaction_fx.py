...
class TransactionFx(BaseModel):
    """
    Foreign exchange rate for the transaction.
    """ # noqa: E501
    receiving_currency: Optional[Currency] = None
    sending_currency: Optional[Currency] = None
    total_receiving_amount: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="The total amount that will be received in the smallest unit of the receiving currency (eg. cents).")
    total_sending_amount: Optional[Annotated[int, Field(strict=True, gt=0)]] = Field(default=None, description="The total amount that will be sent in the smallest unit of the sending currency (eg. cents).")
    multiplier: Optional[Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]] = Field(default=None, description="Number of sending currency units per receiving currency unit.")
    ...
    __properties: ClassVar[List[str]] = ["receiving_currency", "sending_currency", "total_receiving_amount", "total_sending_amount", "multiplier", "fees"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of TransactionFx from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of TransactionFx from a dict"""
        if obj is None:
            return None
