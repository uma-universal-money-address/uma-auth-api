...
class PayKeysendResponse(Model):
    ...
    def __init__(self, preimage=None, total_budget_currency_amount=None):  # noqa: E501
        ...
        :type preimage: str
        :param total_budget_currency_amount: The total_budget_currency_amount of this PayKeysendResponse.  # noqa: E501
    ...
    def total_budget_currency_amount(self) -> int:
        """Gets the total_budget_currency_amount of this PayKeysendResponse.
        ...
        :return: The total_budget_currency_amount of this PayKeysendResponse.
        :rtype: int
        """
    ...
    def total_budget_currency_amount(self, total_budget_currency_amount: int):
        """Sets the total_budget_currency_amount of this PayKeysendResponse.

        The total cost of the payment in the smallest unit of `budget_currency_code` in the request. This is the amount that will be deducted from the budget  for this connection. Optional if `budget_currency_code` is null.   # noqa: E501

        :param total_budget_currency_amount: The total_budget_currency_amount of this PayKeysendResponse.
        :type total_budget_currency_amount: int
        """
