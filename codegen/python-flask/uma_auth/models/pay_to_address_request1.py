...
class PayToAddressRequest1(Model):
    ...
    def __init__(self, receiver_address=None, sending_currency_code=None, sending_currency_amount=None, receiving_currency_code=None):  # noqa: E501
        """PayToAddressRequest1 - a model defined in OpenAPI

        :param receiver_address: The receiver_address of this PayToAddressRequest1.  # noqa: E501
        :type receiver_address: str
        :param sending_currency_code: The sending_currency_code of this PayToAddressRequest1.  # noqa: E501
        :type sending_currency_code: str
        :param sending_currency_amount: The sending_currency_amount of this PayToAddressRequest1.  # noqa: E501
        :type sending_currency_amount: int
        :param receiving_currency_code: The receiving_currency_code of this PayToAddressRequest1.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'PayToAddressRequest1':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The PayToAddressRequest_1 of this PayToAddressRequest1.  # noqa: E501
        :rtype: PayToAddressRequest1
        """
        return util.deserialize_model(dikt, cls)

    @property
    def receiver_address(self) -> str:
        """Gets the receiver_address of this PayToAddressRequest1.

        The BOLT12 address to pay.  # noqa: E501

        :return: The receiver_address of this PayToAddressRequest1.
        :rtype: str
        """
    ...
    def receiver_address(self, receiver_address: str):
        """Sets the receiver_address of this PayToAddressRequest1.

        The BOLT12 address to pay.  # noqa: E501

        :param receiver_address: The receiver_address of this PayToAddressRequest1.
        :type receiver_address: str
        """
    ...
    def sending_currency_code(self) -> str:
        """Gets the sending_currency_code of this PayToAddressRequest1.

        The code of the currency being sent from the sender's wallet.  # noqa: E501

        :return: The sending_currency_code of this PayToAddressRequest1.
        :rtype: str
        """
    ...
    def sending_currency_code(self, sending_currency_code: str):
        """Sets the sending_currency_code of this PayToAddressRequest1.

        The code of the currency being sent from the sender's wallet.  # noqa: E501

        :param sending_currency_code: The sending_currency_code of this PayToAddressRequest1.
        :type sending_currency_code: str
        """
    ...
    def sending_currency_amount(self) -> int:
        """Gets the sending_currency_amount of this PayToAddressRequest1.

        The amount to send in the smallest unit of the sending currency (eg. cents).  # noqa: E501

        :return: The sending_currency_amount of this PayToAddressRequest1.
        :rtype: int
        """
    ...
    def sending_currency_amount(self, sending_currency_amount: int):
        """Sets the sending_currency_amount of this PayToAddressRequest1.

        The amount to send in the smallest unit of the sending currency (eg. cents).  # noqa: E501

        :param sending_currency_amount: The sending_currency_amount of this PayToAddressRequest1.
        :type sending_currency_amount: int
        """
    ...
    def receiving_currency_code(self) -> str:
        """Gets the receiving_currency_code of this PayToAddressRequest1.
        ...
        :return: The receiving_currency_code of this PayToAddressRequest1.
        :rtype: str
        """
    ...
    def receiving_currency_code(self, receiving_currency_code: str):
        """Sets the receiving_currency_code of this PayToAddressRequest1.

        The code of the currency being received by the receiver. If not provided, the receiver's default currency will be used.  # noqa: E501

        :param receiving_currency_code: The receiving_currency_code of this PayToAddressRequest1.
        :type receiving_currency_code: str
        """
